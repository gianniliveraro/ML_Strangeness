...
def DrawEfficiency01(lSpecies="K0Short"):
    ...
    for ibin in range(10):
        ...
        file = ROOT.TFile(f"{lSpecies}_MonteCarloNew2_{centralityBins[ibin]}_{centralityBins[ibin + 1]}.root")
    ...
    file = ROOT.TFile("AnalysisResultsDerivedMCGeneration.root")
    ...
    hDummy2.GetYaxis().SetRangeUser(0, 0.6)
    hDummy2.Draw()
