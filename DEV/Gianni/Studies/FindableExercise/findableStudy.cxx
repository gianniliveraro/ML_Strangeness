...
struct findableStudy {
  ...
  Configurable<int> pdgCodeMother{"pdgCodeMother", 0, "PDG code mother to select"};
  Configurable<int> pdgCodePos{"pdgCodePos", 211, "Positive track PDG code to select"};
  Configurable<int> pdgCodeNeg{"pdgCodeNeg", -211, "Negative track PDG code to select"};
  ...
  {
    if (v0.pdgCode() != pdgCode || v0.pdgCodePositive() != pdgCodePos || v0.pdgCodeNegative() != pdgCodeNeg)
      return;
    if ((v0.pdgCodeMother() != pdgCodeMother) && (pdgCodeMother != 0))
      return;
